...
Apply Bean Validation annotations on all request DTOs and enforce validation via `@Valid` on controller methods, with a global exception handler returning structured 400 error responses.
