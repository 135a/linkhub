...
Replace ad-hoc AtomicLong counters with Micrometer MeterRegistry for Prometheus-compatible metrics, fix async monitoring data loss, and add structured logging with logback.
...
系统 MUST 提供 `logback-spring.xml` 配置文件，支持控制台文本输出和文件按天滚动输出。
